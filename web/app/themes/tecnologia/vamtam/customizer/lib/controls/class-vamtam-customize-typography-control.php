...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'tecnologia' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'tecnologia' ),
			'font-weight'                     => esc_html__( 'Weight', 'tecnologia' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'tecnologia' ),
				'uppercase'    => esc_html__( 'Uppercase', 'tecnologia' ),
				'lowercase'    => esc_html__( 'Lowercase', 'tecnologia' ),
				'capitalize'   => esc_html__( 'Capitalize', 'tecnologia' ),
				'normal'       => esc_html__( 'Normal', 'tecnologia' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'tecnologia' ),
				'normal'       => esc_html__( 'Normal', 'tecnologia' ),
				'italic'       => esc_html__( 'Italic', 'tecnologia' ),
				'oblique'      => esc_html__( 'Oblique', 'tecnologia' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'tecnologia' ),
				'underline'    => esc_html__( 'Underline', 'tecnologia' ),
				'overline'     => esc_html__( 'Overline', 'tecnologia' ),
				'line-through' => esc_html__( 'Line Through', 'tecnologia' ),
				'none'         => esc_html__( 'None', 'tecnologia' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'tecnologia' ),
			'line-height'                => esc_html__( 'Line Height', 'tecnologia' ),
			'color'                      => esc_html__( 'Font Color', 'tecnologia' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'tecnologia' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'tecnologia' ), [ 'code' => [] ] ),
		);
	}
	/**
