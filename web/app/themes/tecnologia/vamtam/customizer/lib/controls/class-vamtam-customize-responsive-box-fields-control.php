...
class Vamtam_Customize_Responsive_Box_Fields_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'top'       => esc_html__( 'Top', 'tecnologia' ),
			'right'     => esc_html__( 'Right', 'tecnologia' ),
			'bottom'    => esc_html__( 'Bottom', 'tecnologia' ),
			'left'      => esc_html__( 'Left', 'tecnologia' ),
			'padding'   => esc_html__( 'Padding', 'tecnologia' ),
		);
	}
	/**
