...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'tecnologia' ),
			'change'       => esc_html__( 'Change Image', 'tecnologia' ),
			'remove'       => esc_html__( 'Remove', 'tecnologia' ),
			'default'      => esc_html__( 'Default', 'tecnologia' ),
			'placeholder'  => esc_html__( 'No image selected', 'tecnologia' ),
			'frame_title'  => esc_html__( 'Select Image', 'tecnologia' ),
			'frame_button' => esc_html__( 'Choose Image', 'tecnologia' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'tecnologia' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'tecnologia' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'tecnologia' ),
				'repeat'    => esc_html__( 'Repeat both', 'tecnologia' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'tecnologia' ),
				'fixed'  => esc_html__( 'fixed', 'tecnologia' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'tecnologia' ),
				'cover'   => esc_html__( 'cover', 'tecnologia' ),
				'contain' => esc_html__( 'contain', 'tecnologia' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'tecnologia' ),
				'left center'   => esc_html__( 'left center', 'tecnologia' ),
				'left bottom'   => esc_html__( 'left bottom', 'tecnologia' ),
				'center top'    => esc_html__( 'center top', 'tecnologia' ),
				'center center' => esc_html__( 'center center', 'tecnologia' ),
				'center bottom' => esc_html__( 'center bottom', 'tecnologia' ),
				'right top'     => esc_html__( 'right top', 'tecnologia' ),
				'right center'  => esc_html__( 'right center', 'tecnologia' ),
				'right bottom'  => esc_html__( 'right bottom', 'tecnologia' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'tecnologia' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'tecnologia' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'tecnologia' ),
			'background-repeat'     => esc_html__( 'Repeat', 'tecnologia' ),
			'background-image'      => esc_html__( 'Image', 'tecnologia' ),
			'background-attachment' => esc_html__( 'Attachment', 'tecnologia' ),
			'background-size'       => esc_html__( 'Size', 'tecnologia' ),
			'background-position'   => esc_html__( 'Position', 'tecnologia' ),
			'background-color'      => esc_html__( 'Color', 'tecnologia' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'tecnologia' ),
				'color-2'              => esc_html__( 'Color 2', 'tecnologia' ),
				'location'             => esc_html__( 'Location', 'tecnologia' ),
				'type'                 => esc_html__( 'Type', 'tecnologia' ),
				'position'             => esc_html__( 'Position', 'tecnologia' ),
				'angle'                => esc_html__( 'Angle', 'tecnologia' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'tecnologia' ),
					'radial' => esc_html__( 'Radial', 'tecnologia' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'tecnologia' ),
					'center left'   =>  esc_html__( 'Center Left' , 'tecnologia' ),
					'center right'  =>  esc_html__( 'Center Right' , 'tecnologia' ),
					'top center'    =>  esc_html__( 'Top Center' , 'tecnologia' ),
					'top left'      =>  esc_html__( 'Top Left' , 'tecnologia' ),
					'top right'     =>  esc_html__( 'Top Right' , 'tecnologia' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'tecnologia' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'tecnologia' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'tecnologia' ),
				],
			],
		);
